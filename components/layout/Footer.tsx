...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-grid">
      ...
      <div><p className="footer-heading">Contact</p><a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a><a href={whatsappHref}>WhatsApp: {siteConfig.phone}</a><p>REVIEW REQUIRED: legal company address.</p></div>
    </div>
    <div className="footer-bottom"><span>© {new Date().getFullYear()} {siteConfig.brandName}</span><span>REVIEW REQUIRED: legal company information.</span></div>
  </footer>;
}
