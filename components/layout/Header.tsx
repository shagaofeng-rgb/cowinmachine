...
export function Header() {
  ...
  return <>
    ...
    <aside ref={drawerRef} id="site-drawer" className={`site-drawer ${open ? "open" : ""}`} role="dialog" aria-modal="true" aria-label="Site menu" tabIndex={-1}>
      <div className="drawer-top"><SiteLogo inverse onClick={() => setOpen(false)} /><button className="close-button" type="button" onClick={() => setOpen(false)} aria-label="Close menu">×</button></div>
