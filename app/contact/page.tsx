...
export const metadata = pageMetadata("Contact", "Contact cowinmachine to discuss mobile lighting or site monitoring requirements.", "/contact");

export default function ContactPage() {
  return <>
    <PageHero eyebrow="Contact" title="Contact Our Team" description="Share your site requirements and equipment objective to begin a focused review." />
