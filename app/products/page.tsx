...
export const metadata = pageMetadata("Mobile Lighting & Site Monitoring Equipment", "Explore independently structured mobile lighting and site monitoring product entries pending technical and media verification.", "/products");

export default function ProductsPage() {
  return <>
    <PageHero
      eyebrow="Products"
      title="Mobile Lighting & Site Monitoring Equipment"
      description="Three independently structured equipment categories. Every entry remains review-gated until verified evidence and media authorization are available."
    />
